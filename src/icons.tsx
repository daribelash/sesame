// Line icons matching the design handoff exactly (see
// design_handoff_first_run_experience/first-run-experience.html). Inline SVG
// rather than an icon library — this app doesn't have a UI kit, and this is
// a small fixed set. stroke="currentColor" so dark mode adapts via the
// wrapping element's color, rather than hardcoding the mockup's light-mode
// hex values.
...
export function GateIcon({ size = 30 }: IconProps) {
  return (
...
export function LockIcon({ size = 15 }: IconProps) {
  return (
    <svg aria-hidden="true" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 2a3 3 0 0 0-3 3v3H8a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2v-9a2 2 0 0 0-2-2h-1V5a3 3 0 0 0-3-3z" />
    </svg>
  )
}
